...
import com.example.leveliiandiii.app.ext.Constants
...
class NetworkModule {
    ...
    @AppScope
    @Provides
    fun levelIIAndIIINetwork(retrofit: Retrofit): LevelIIAndIIINetwork {
        return retrofit.create(LevelIIAndIIINetwork::class.java)
    }
}
